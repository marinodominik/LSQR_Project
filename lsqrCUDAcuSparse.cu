...
CPUMatrix sparseLSQR(const CPUMatrix &A, const CPUMatrix &b, double ebs){
    ...
    cusparseSpVecDescr_t u,v,w,x,tempVector;
    ...
    cusparseCreateSpVec(&u,b.height,b.elementSize,b.csrCol,zeros,CUSPARSE_INDEX_32I,CUSPARSE_INDEX_BASE_ZERO,CUDA_R_64F);
    cusparseCreateSpVec(&v,b.height,b.elementSize,b.csrCol,zeros,CUSPARSE_INDEX_32I,CUSPARSE_INDEX_BASE_ZERO,CUDA_R_64F);
    cusparseCreateSpVec(&w,b.height,b.elementSize,b.csrCol,zeros,CUSPARSE_INDEX_32I,CUSPARSE_INDEX_BASE_ZERO,CUDA_R_64F);
    cusparseCreateSpVec(&x,b.height,b.elementSize,b.csrCol,zeros,CUSPARSE_INDEX_32I,CUSPARSE_INDEX_BASE_ZERO,CUDA_R_64F);

    
    cleanCusparse(spMatrixA,);
